    ...
    <div className='clients-content'>
        ...
        <div className="clients-info-container">
            ...
            <div className="all-clients-image-container">
                <div>
                    <img className="clients-avatar-image" src="../public/image/avatar1.jpg" alt="client" />
                    <img className="clients-avatar-image" src="../public/image/avatar2.jpg" alt="client" />
                    <img className="clients-avatar-image" src="../public/image/avatar3.jpg" alt="client" />
                </div>
            </div>
        </div>

        <div >
            <img className="clients-avatar" src="public/image/avatar3.jpg" alt="client"/>
        </div>
    </div>
  )
}
